...
class MCU_pwm:
    ...
    def set_pwm(self, print_time, value, cycle_time=None):
        ...
        if self._hardware_pwm:
            ...
            # self._mcu.ghead.nprintf("try set v %d,_pwm_max %.1f "%(v,self._pwm_max))
...
class MCU_ghead:
    ...
    def zlock_release(self):
        self.set_normal_ghead_ctrl(ord('Z'),0,1) 
                    ...
                    if val == 3:
                        if 'S' in cmd_params:
                            ...
                            if sval == 88:
                                ...
                                x_data_is_ok = True
                                y_data_is_ok = True
                                self.nprintf("lets just check it")
    ...
    def handle_ghead_temp(self,params):    
        ...
        if params['gh_ptr'] == 0 and self._tempv['left'] != None:
            ...
            # self.nprintf("heat0 %.1f"%self._tempv['left'])
